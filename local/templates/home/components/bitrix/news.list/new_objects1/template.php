...
<div class="slide-one-item home-slider owl-carousel">
    ...
    <div 
        ...
        style="background-image: url(<?=$arItem["DISPLAY_PROPERTIES"]?>);" 
        data-aos="fade" 
        data-stellar-background-ratio="0.5">
        <div class="text">
          <h2><?echo $arItem["NAME"]?></h2>
          <p class="location"><span class="property-icon icon-room"></span> <?echo $arItem["PREVIEW_TEXT"]?></p>
          <p class="mb-2"><strong><?=$arItem["DISPLAY_PROPERTIES"]["PRICE"]?></strong></p>
...
/local/templates/home/images/hero_bg_1.jpg
